...
public class ArtikalJSON implements Serializable {
	...
	public ArtikalJSON(String kataloskiBroj, Integer kolicina) {
		super();
		this.kataloskiBroj = kataloskiBroj;
		this.kolicina = kolicina;
	}
	public ArtikalJSON(String kataloskiBroj, Integer kolicina, Double tezina) {
		super();
		this.kataloskiBroj = kataloskiBroj;
		this.kolicina = kolicina;
		this.tezina = tezina;
	}
	public ArtikalJSON(String nazivProizvoda, String tipProizvoda, String kataloskiBroj, Integer kolicina) {
		super();
	...
	public ArtikalJSON(String nazivProizvoda, String tipProizvoda, String kataloskiBroj, Integer kolicina, Double tezina) {
		super();
		this.nazivProizvoda = nazivProizvoda;
		this.tipProizvoda = tipProizvoda;
		this.kataloskiBroj = kataloskiBroj;
