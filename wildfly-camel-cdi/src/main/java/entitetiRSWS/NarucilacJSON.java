...
public class NarucilacJSON implements Serializable {
	...
	public NarucilacJSON() {
		super();
	}
	public NarucilacJSON(String nazivNarucioca, String adresaNarucioca, String kontaktNarucioca, String mesto) {
		super();
