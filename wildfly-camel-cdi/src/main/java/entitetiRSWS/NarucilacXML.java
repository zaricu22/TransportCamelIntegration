...
public class NarucilacXML implements Serializable {
	...
	public NarucilacXML(String nazivNarucioca, String adresaNarucioca, String kontaktNarucioca, String mesto) {
		super();
